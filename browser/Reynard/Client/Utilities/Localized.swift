...
struct Localized {
    ...
    static let addonViolatesPolicies = "\(resolvedAddonName) 违反了 Mozilla 的政策，无法在 Reynard 上安装。"
    static let restricted = "受限"
    static let addonRestricted = "\(resolvedAddonName) 受限，无法在 Reynard 上安装。"
    ...
    static let incompatibleMessage = "\(resolvedAddonName) 无法安装，因为它与此版本的 Reynard 不兼容。"
    static let adminOnly = "仅限管理员"
    static let adminOnlyMessage = "\(resolvedAddonName) 无法安装，因为它只能由使用企业策略的组织安装，此平台不支持。"
    static let error = "错误"
    static let updateFailed = "更新失败"
    static let failedToInstallAddon = "未能安装 \(addonName)。"
    static let failedToInstallThisExtension = "未能安装此扩展。"
    static let needsPermissionToUpdate = "需要权限才能更新"
    static let addonNeedsPermissionToUpdate = "\(count) 个扩展需要权限才能更新。"
    ...
    static let errorUserCanceled = "ERROR_USER_CANCELED"
    static let errorAborted = "ERROR_ABORTED"
    static let errorUserCancelled = "ERROR_USER_CANCELLED"
}
